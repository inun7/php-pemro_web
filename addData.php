    ...
    <center>
      ...
      <form action="" class="form" method="POST">
        <table class="table" border=1>
          ...
          <tr>
            <td width="10%">PDP</td>
            <td> <input type="number" class="form-control" name="pdp"> </td>
          </tr>
          <tr>
            <td width="10%">ODP</td>
            <td> <input type="number" class="form-control" name="odp"> </td>
          </tr>
        </table>
...
if(isset($_POST['add'])) {
  ...
  $pdp = $_POST['pdp'];
  $odp = $_POST['odp'];
  // manggil fungsi simpan yang ada di file config.php dengan parameter(nama_tabel, nama_kolom, value)
  $q = simpan("data", "kecamatan,positif,pdp,odp", "'$kecamatan','$positif','$pdp','$odp'");
  if ($q) {
      echo "<script>alert('Data berhasil ditambahkan.'); window.location.href='adminBerita.php';</script>";
  } else {
