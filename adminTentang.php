          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown-a">
                ...
                <a class="dropdown-item active" href="adminTentang.php">Tentang</a>
          ...
          <aside class="single_sidebar_widget author_widget">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>Tentang Kami</h3>
                    <p class="lead">
                      Semoga website ini dapat membantu Pemerintah Kabupaten Jember dalam menyalurkan informasi seputar Covid-19 kepada Masyarakat.
                    </p>
                </div>
              </div><!-- end title -->
          </aside>
