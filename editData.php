...
include 'config.php';
$id = $_GET['id'];
$data = mysqli_fetch_array(tampil('data', " where idData='$id'"));
 ...
 <!-- Logika Tampil dan Tambah Berita -->
   <center>
     <br>
     <a href="adminData.php"> <input type="button" class="btn btn-secondary" value="Kembali Ke Rekap Data"> </a>

     <br> <br>

     <form action="editData.php" class="form" method="POST">
       <table class="table" border=1>
         <tr>
           <td width="10%">Kecamatan</td>
           <td> <input type="text" class="form-control" name="kecamatan" value="<?= $data['kecamatan']?>"> </td>
         </tr>
         <tr>
           <td width="10%">Positif</td>
           <td> <input type="number" class="form-control" name="positif" value="<?= $data['positif'] ?>"> </td>
         </tr>
         <tr>
           <td width="10%">PDP</td>
           <td> <input type="number" class="form-control" name="pdp" value="<?= $data['pdp'] ?>"> </td>
         </tr>
         <tr>
           <td width="10%">ODP</td>
           <td> <input type="number" class="form-control" name="odp" value="<?= $data['odp']?>"> </td>
         </tr>
       </table>
       <input type="hidden" name="id" value=<?= $data['idData']; ?>>
...
if (isset($_POST['update'])) {
  ...
  $cekquery = update("data", "idData", $id, "kecamatan='$kecamatan', positif='$positif', pdp='$pdp', odp='$odp'");
  if ($cekquery) {
      echo "<script>alert('Data berhasil diupdate.'); window.location.href='adminData.php';</script>";
  } else {
