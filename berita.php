  ...
  <!-- End header -->
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Berita<span class="m_1">Update pengetahuan covid-19 anda disini.</span></h1>
		</div>
	</div>
              ...
              $no = 1;
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-item">
                          ...
                          <a href="showBerita.php?id=<?= $data['idBerita']?>">
                            <?php echo "<img src='images/".$data['foto']."' height='225'>";?>
                          </a>
            						</div>
            						<div class="blog-title">
            							<h2><a href="showBerita.php?id=<?= $data['idBerita']?>" title=""><?= $data['judul'] ?></a></h2>
            						</div>
            						<!-- <div class="blog-desc">
            							<p></p>
            						</div> -->
            						<div class="blog-button">
            							<a href="showBerita.php?id=<?= $data['idBerita']?>">
                            <input type="button" class="btn btn-info" value="Baca Selengkapnya">
                          </a>
            						</div>
					           </div>
                     <br>
